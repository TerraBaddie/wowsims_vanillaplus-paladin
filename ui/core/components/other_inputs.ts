...
export function makePhaseSelector(parent: HTMLElement, sim: Sim): EnumPicker<Sim> {
	return new EnumPicker<Sim>(parent, sim, {
		...
		values: [
			{ name: 'Phase 6 - SM', value: 6 },
			{ name: 'Phase 5 - BWL', value: 5 },
			{ name: 'Phase 4 - MC/Onyxia', value: 4 },
			{ name: 'Phase 3 - ZG', value: 3 },
			{ name: 'Phase 2 - World Bosses', value: 2 },
			{ name: 'Phase 1 - Pre-raid', value: 1 },
		],
